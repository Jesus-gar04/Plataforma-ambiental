      ...
      <aside class="w-64 bg-white shadow-xl fixed h-screen overflow-y-auto">
        <div class="p-6 border-b border-gray-200">
          <div class="flex items-center">
            ...
            <div class="ml-3">
              <h2 class="text-lg font-bold bg-gradient-to-r from-unilibre-blue to-blue-600 bg-clip-text text-transparent">
                Panel Director
              </h2>
        ...
        <nav class="p-4">
          <router-link
            ...
            :class="$route.path === item.path 
              ? 'bg-gradient-to-r from-unilibre-blue to-blue-600 text-white shadow-lg' 
        ...
        <div class="absolute bottom-0 w-64 p-4 border-t border-gray-200 bg-white">
          <div class="flex items-center mb-3">
            <div class="w-10 h-10 rounded-full bg-gradient-to-br from-unilibre-blue to-blue-600 flex items-center justify-center text-white font-bold">
              {{ userInitials }}
            </div>
...
const menuItems = [
  { path: '/director', label: 'Dashboard', icon: LayoutDashboard },
  { path: '/director/students', label: 'Estudiantes', icon: Users }
]
